...
var LayerCached = (function (_super) {
    ...
    LayerCached.prototype.draw = function (context) {
        if (this.caching) {
            ...
            var _a = this.clipRegion ? this.clipRegion : this.getBounds(), minX = _a.minX, minY = _a.minY, maxX = _a.maxX, maxY = _a.maxY;
    ...
    LayerCached.prototype.drawDeferred = function (context, stepAccumulator, commitAccumulator) {
        ...
        var _a = this.clipRegion ? this.clipRegion : this.getBounds(), minX = _a.minX, minY = _a.minY, maxX = _a.maxX, maxY = _a.maxY;
        if (!this.cache) {
            var _b = _super.prototype.getBounds.call(this), realMinX_1 = _b.minX, realMinY_1 = _b.minY;
            ...
            stepAccumulator.push(function () { return cacheContext_1.translate(-realMinX_1 - minX, -realMinY_1 - minY); });
            ...
            for (var _c = 0, cacheCommitAccumulator_1 = cacheCommitAccumulator; _c < cacheCommitAccumulator_1.length; _c++) {
                var cacheCommit = cacheCommitAccumulator_1[_c];
